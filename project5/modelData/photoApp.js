...
(function() {
   ...
   // Create init users.
   var Zaya={_id:"216512318qe156489711006",first_name:"Zaya",last_name:"Mygmar",
               location:"Mongolia UB",description:"My name is Zaya",occupation:"ZayaMygmar"};
   ...
   var users = [Zaya,im, er, pt, rk, al, jo];
